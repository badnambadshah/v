...
def uaku():
	try:
		...
		a=requests.get('https://github.com/badnambadshah/Approval.txt/blob/main/Approval.txt').text
		ua=open('.bbnew.txt','w')
...
def banner():
	...
	sol().print(cik2)
	ban='''
•   AUTHOR : VIKASH KING • WHATSAPP : +916376264046  •
...
•                                               •
•   GITHUB : HTTPS://GITHUB.COM/badnambadshah   •'''
